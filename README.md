...
-   [Commandes CLI](#Commandes-CLI)
    ...
    -   [Modifier l'état des postes](#Modifier-l'état-des-postes)
...
L'application est livrée avec un environnement de développement conteneurisé intégré. Pour l'installer, veuillez suivre les étapes d'installation.
...
L'application sera disponible à la fois à l'adresse `https://localhost:8004` et à l'adresse `http://simple-roster.docker.localhost/api/v1` .
