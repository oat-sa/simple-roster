...
use OAT\SimpleRoster\Lti\Model\AutogeneratedAssigment;
...
class CsvFilesystemStorage implements StorageInterface
{
     ...
     * @inheritdoc
     */
    public function persistAssignments(string $key, array $data): void
    {
        $this->csvWriter->writeCsv(
            $this->getPath($key),
    ...
    /**
     * @param AutogeneratedAssigment[] $assignments
     * @return string[][]
     */
    protected function castAssignments(array $assignments): array
    {
        $res = [];
        foreach ($assignments as $assignment) {
            $res[] = [$assignment->getUser()->getName(), $assignment->getSlug()];
        }
