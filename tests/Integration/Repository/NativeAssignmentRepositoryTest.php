...
class NativeAssignmentRepositoryTest extends KernelTestCase
{
    ...
    {
        $assignment1 = new AssignmentDto(11, Assignment::STATE_READY, 1, 1);
        $assignment2 = new AssignmentDto(12, Assignment::STATE_READY, 1, 1);
        $assignment3 = new AssignmentDto(13, Assignment::STATE_READY, 1, 1);
        ...
        $this->assertCount(3, $this->assignmentRepository->findBy(['id' => [11, 12, 13]]));
    }
}
