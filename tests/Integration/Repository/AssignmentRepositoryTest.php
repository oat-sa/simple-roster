...
class AssignmentRepositoryTest extends KernelTestCase
{
    ...
    public function testItCanInsertMultipleAssignments(): void
    {
        ...
        $assignment1 = new AssignmentDto($assignmentId1, Assignment::STATUS_READY, $lineItemId, 'user1', 1);

        $assignmentId2 = new UuidV6('00000002-0000-6000-0000-000000000000');
        $assignment2 = new AssignmentDto($assignmentId2, Assignment::STATUS_READY, $lineItemId, 'user2', 1);

        $assignmentId3 = new UuidV6('00000003-0000-6000-0000-000000000000');
        $assignment3 = new AssignmentDto($assignmentId3, Assignment::STATUS_READY, $lineItemId, 'user3', 1);
