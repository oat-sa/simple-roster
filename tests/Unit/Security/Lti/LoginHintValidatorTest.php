...
class LoginHintValidatorTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new LoginHintValidator($this->loginHintExtractor, $this->userRepository);

        $this->setUpDatabase();
        $this->loadFixtureByFilename('userWithReadyAssignment.yml');
    }

    public function testLoginHintIsValid(): void
    {
        ...
        $result = $this->subject->validate($loginHint);
